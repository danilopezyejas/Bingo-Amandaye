...
function App() {
  ...
  <div className="flex flex-col h-screen items-stretch bg-gray-50 overflow-hidden">
      ...
      {/* Main content */}
      <main className="flex-1 flex flex-col lg:flex-row items-stretch gap-4 w-full px-4 py-4 min-h-0 overflow-hidden">
        <div className="flex flex-col lg:w-1/3 justify-center items-center min-w-[200px]">
          <BingoWheel
        ...
        <div className="flex flex-col lg:w-2/3 justify-center min-w-0">
          ...
          <div className="mt-2 w-full flex justify-end">
            <button
              onClick={handleReset}
              className="w-max px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white font-bold rounded-lg hover:from-red-600 hover:to-red-700 transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl text-lg"
            >
              🔄 Reiniciar Sorteo
            </button>
            {drawnCount === 76 && (
